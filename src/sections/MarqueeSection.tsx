...
function MarqueeRow({ images, offset }: { images: string[]; offset: number }) {
  // Tripled so the strip stays filled while it slides in either direction.
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3">
        <MarqueeRow images={ROW_ONE} offset={offset - 200} />
        <MarqueeRow images={ROW_TWO} offset={-(offset - 200)} />
      </div>
    </section>
  );
}
